        ...
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    column(CompanyInfo_Include_Company_Title; '')
                    {
                    }
                    column(Financial_Charges_Caption; '')
                    {
                    }
                    column(All_legal_fees_Caption; '')
                    {
                    }
            ...
            begin
                ...
                if DownPaymlentLine.FindSet() then begin
                    DownPaymlentLine.CalcSums("Line Amount", "Amount Including VAT", Amount);
                    //LineAmt := DownPaymlentLine."Line Amount";
                    LineAmt := DownPaymlentLine.Amount;
                ...
                */
                ...
                CustAddr[1] := "Sales Invoice Header"."Sell-to Customer Name" + '' + "Sales Invoice Header"."Sell-to Customer Name 2";
                CustAddr[2] := "Sales Invoice Header"."Sell-to Address";
                CustAddr[3] := "Sales Invoice Header"."Sell-to Address 2";
                CustAddr[4] := "Sales Invoice Header"."Sell-to City";
                IF Country.GET("Sales Invoice Header"."Sell-to Country/Region Code") THEN
                    CustAddr[5] := Country.Name;
                ShipToAddr[1] := "Sales Invoice Header"."Sell-to Customer Name" + '' + "Sales Invoice Header"."Sell-to Customer Name 2";
                ShipToAddr[2] := "Sales Invoice Header"."Sell-to Address";
                ShipToAddr[3] := "Sales Invoice Header"."Sell-to Address 2";
                ShipToAddr[4] := "Sales Invoice Header"."Sell-to City";
                IF Country.GET("Sales Invoice Header"."Sell-to Country/Region Code") THEN
